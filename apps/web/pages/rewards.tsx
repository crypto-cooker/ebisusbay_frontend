        ...
        <Box mt={8}>
          <Flex direction='column'>
            ...
            <Box fontSize='sm'>
              ...
              <Text as='span' fontWeight='bold' className='color'><Link href='https://docs.ebisusbay.com/Rewards-aa425cc2207c42a996e1a5e8b03fc00a' isExternal>Learn more</Link></Text>
            </Box>
            <Box fontSize='sm'>
