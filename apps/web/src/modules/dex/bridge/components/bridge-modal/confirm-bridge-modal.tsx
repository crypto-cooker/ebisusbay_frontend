...
import TransactionConfirmBridgeContent, {
  ParsedBridge,
} from '@dex/bridge/components/transaction-confirmation-modal/confirmation-modal-content';
...
export default function ConfirmBridgeModal({
  ...
  const confirmationContent = useCallback(
    ...
    [onConfirm, recipient, currencyBalance],
  );
