import { Container, Box, IconButton, VStack, HStack, ButtonGroup, Flex, Wrap, Button, Text, Skeleton, Select, Input, Alert, AlertIcon } from "@chakra-ui/react";
        ...
        <Card>
          ...
          <VStack w='full' align='stretch' spacing={4}>
            <Alert status='info'>
              <AlertIcon />
              <Box fontSize='sm'>
                Bridge FRTN to and from any Ebisu's Bay supported chain!
              </Box>
            </Alert>
            <Card mb={4}>
