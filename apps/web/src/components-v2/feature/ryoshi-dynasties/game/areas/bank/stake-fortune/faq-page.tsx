...
const FaqPage = () => {
  ...
  return (
    <Stack spacing={3}className={gothamBook.className} fontSize={{ base: 'xs', md: 'sm' }}>
      <Text p={4}>
        Stake $FRTN to receive Troops and earn $FRTN rewards. Troops are essential to play Ryoshi Dynasties, by battling other Factions and taking victory over control points to earn additional rewards. The more you stake, the more Troops you will receive and a higher APR% will be earned. Stake in multiple vaults to match your gameplay strategies.
      </Text>
      <Accordion fontSize='sm' defaultIndex={[0]}>
        <AccordionItem>
          ...
          <AccordionPanel pb={4}>
            <RdModalBox>
              <Text>To stake $FRTN, simply create a vault by clicking the <strong>"+ New Vault"</strong> button. From there, choose how much to stake and for how long.</Text>
        ...
        <AccordionItem>
          ...
          <AccordionPanel pb={4}>
            <RdModalBox>
              <Text>Yes, a vault can have either its Fortune amount or staking duration changed. To update
              the amount to stake, click the <strong>"+ Add Fortune"</strong> button. To update the staking duration,
              click the <strong>"+ Increase duration"</strong> button. From here, you can modify the values and also see
              a preview of the vault's new APR, Troop count and end date.</Text>
            </RdModalBox>
          </AccordionPanel>
        </AccordionItem>
        <AccordionItem>
        ...
        <AccordionItem>
          <AccordionButton fontSize='sm' fontWeight='bold'>
            <Box as="span" flex='1' textAlign='left' fontSize='sm'>
              How do I convert a FRTN vault to an LP vault?
            </Box>
            <AccordionIcon />
          </AccordionButton>
          <AccordionPanel pb={4}>
            <RdModalBox>
              <Text>Converting FRTN vaults to LP vaults yield more mitama and more troops. To convert, select the
                desired FRTN vault and click <strong>"+ Convert to LP Vault"</strong> </Text>
              <Text mt={2}>From here, any FRTN amount from the vault can be added to either a new or existing LP vault.</Text>
            </RdModalBox>
          </AccordionPanel>
        </AccordionItem>
        <AccordionItem>
