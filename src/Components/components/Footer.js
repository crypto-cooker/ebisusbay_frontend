...
const Footer = () => {
  ...
  return (
    <footer className="footer-light" style={{zIndex:5, position: 'relative'}}>
          ...
          <div className="col-md-3 col-sm-6 col-xs-1">
            <div className="widget">
              ...
              <ul>
                ...
                <li><a href="https://cdn.ebisusbay.com/privacy-policy.html" target="_blank" rel="noreferrer">Privacy Policy</a></li>
              </ul>
            </div>
          </div>
          <div className="col-md-3 col-sm-6 col-xs-1">
