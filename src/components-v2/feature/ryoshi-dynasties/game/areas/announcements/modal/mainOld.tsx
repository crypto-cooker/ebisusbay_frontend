...
const MainPageOld = ({handleShowLeaderboard, onOpenDailyCheckin}: Props) => {
  ...
  return (
    <VStack padding='2'>
      ...
      {/*/>*/}
        <Link as={NextLink} href='https://swap.ebisusbay.com/#/swap?outputCurrency=0xaF02D78F39C0002D14b95A3bE272DA02379AfF21&inputCurrency=0xc21223249CA28397B4B6541dfFaEcC539BfF0c59' isExternal>
          {isMobile ? (
            <Image
              alt="Buy FRTN on VVS"
        ...
        <GridItem rowSpan={2} colSpan={2} bg='#272523' p={4} textAlign='center' rounded='md'>
          ...
          <VStack mt={4}>
            ...
            <Box
              ...
              _focus={{ boxShadow: "outline" }}
              onClick={() => {
                window.open('https://swap.ebisusbay.com/#/swap?outputCurrency=0xaF02D78F39C0002D14b95A3bE272DA02379AfF21&inputCurrency=0xc21223249CA28397B4B6541dfFaEcC539BfF0c59','_blank');              }}
            >
              Buy FRTN
            </Box>
          </VStack>
