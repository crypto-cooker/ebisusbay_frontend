...
import {useSwapTaxes} from "@dex/hooks/useSwapTaxes";
import {useCurrencyBalances} from "@dex/hooks/useCurrencyBalance";
import useAutoSlippageTolerance from '@dex/hooks/useAutoSlippageTolerance';
import { useDebouncedTrade } from '@dex/hooks/useDebouncedTrade';
import {isAddress} from "@market/helpers/utils";
import {TOKEN_SHORTHANDS} from "@dex/constants/tokens";
import {useUSDPrice} from "@dex/hooks/useUSDPrice";
import tryParseCurrencyAmount from "@dex/utils/tryParseCurrencyAmount";
import {isClassicTrade, isSubmittableTrade, isUniswapXTrade} from "@dex/state/routing/utils";
