...
import {FACTORY_ADDRESS_MAP, INIT_CODE_HASH_MAP} from "@dex/swap/constants/evm";
...
export class Pair {
  ...
  public getOutputAmount(inputAmount: CurrencyAmount<ERC20Token>): [CurrencyAmount<ERC20Token>, Pair] {
    ...
    console.log('come on', typeof inputAmount.quotient, typeof _9975, inputAmount.quotient);
