import {ChainId, Currency, CurrencyAmount, Price, Trade, TradeType} from '@eb-pancakeswap/sdk'
import {FRTN, STABLE_COIN, USDC, USDT} from '@eb-pancakeswap/tokens'
...
import {getTokenAddress} from "@dex/swap/utils/getTokenAddress";
