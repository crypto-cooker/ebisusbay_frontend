import { Currency, CurrencyAmount, pancakePairV2ABI } from 'pancakeswap/sdk'
import { useMemo } from 'react'

import { useMultipleContractSingleData } from 'pancakeswap/state/multicall/hooks'
import { wrappedCurrency } from 'pancakeswap/utils/wrappedCurrency'
import { useActiveChainId } from './useActiveChainId'
import {Pair} from "@dex/swap/overrides/pancakeswap/pair";
import PairAbi from "@src/global/contracts/LP.json";
import Exchange from "@src/core/services/api-service/graph/subgraphs/exchange";
import { useQuery, gql } from '@apollo/client';
import {useGetPairs} from "@dex/swap/hooks/useGetPairs";
