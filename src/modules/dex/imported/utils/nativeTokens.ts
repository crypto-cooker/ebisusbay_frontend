import { MATIC_POLYGON, nativeOnChain } from '@dex/imported/constants/tokens'
import { supportedChainIdFromGQLChain } from '@dex/imported/graphql/data/util'
import { Chain } from '@dex/imported/packages/uniswap/src/data/graphql/uniswap-data-api/__generated__/types-and-hooks'
