...
import { useActiveLocale } from '@dex/imported/hooks/useActiveLocale'
import usePrevious from '@dex/imported/hooks/usePrevious'
import { useCallback, useMemo } from 'react'
import { Currency as GqlCurrency } from '@dex/imported/packages/uniswap/src/data/graphql/uniswap-data-api/__generated__/types-and-hooks'
import { FeatureFlags } from '@dex/imported/packages/uniswap/src/features/statsig/flags'
import { useFeatureFlag } from '@dex/imported/packages/uniswap/src/features/statsig/hooks'
import {DEFAULT_LOCALE, SupportedLocale} from "@dex/imported/constants/locales";
import {
  DEFAULT_LOCAL_CURRENCY,
  LOCAL_CURRENCY_SYMBOL_DISPLAY_TYPE,
  SupportedLocalCurrency
} from "@dex/imported/constants/localCurrencies";
import {useActiveLocalCurrency} from "@dex/imported/hooks/useActiveLocalCurrency";
import {Bound} from "@dex/imported/state/mint/v3/actions";
...
export function useFormatter() {
  ...
  const localCurrencyConversionRateIsLoading = false;
