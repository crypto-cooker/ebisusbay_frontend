...
import ARGENT_WALLET_DETECTOR_ABI from '@dex/imported/packages/uniswap/src/abis/argent-wallet-detector.json'
import EIP_2612 from '@dex/imported/packages/uniswap/src/abis/eip_2612.json'
import ENS_PUBLIC_RESOLVER_ABI from '@dex/imported/packages/uniswap/src/abis/ens-public-resolver.json'
import ENS_ABI from '@dex/imported/packages/uniswap/src/abis/ens-registrar.json'
import ERC1155_ABI from '@dex/imported/packages/uniswap/src/abis/erc1155.json'
import ERC20_ABI from '@dex/imported/packages/uniswap/src/abis/erc20.json'
import ERC20_BYTES32_ABI from '@dex/imported/packages/uniswap/src/abis/erc20_bytes32.json'
import ERC721_ABI from '@dex/imported/packages/uniswap/src/abis/erc721.json'
import {
