...
import { AVERAGE_L1_BLOCK_TIME } from '@dex/imported/constants/chainInfo'
...
import {useRoutingAPIArguments} from "@dex/imported/hooks/useRoutingAPIArguments";
...
console.log('===TRADE isFETCHING', isFetching);
  return useMemo(() => {
